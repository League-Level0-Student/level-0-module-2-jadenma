...
public class StringsCannotAdd {
	...
	public static void main(String[] args) {
			...
			int numFour = Integer.parseInt(fourAsString);
			int numSix = Integer.parseInt(sixAsString);
			JOptionPane.showMessageDialog(null, numFour+numSix);
			...
			int numFive = Integer.parseInt(fiveAsString);
			JOptionPane.showMessageDialog(null, numFour+numFive+numSix);
